...
if(retweet_1.length==0||retweet_2.length==0){
    $('#person_content #content_left .social .soc_one .user').html("暂无数据");
}else{
...
if(beretweet_1.length==0||beretweet_2.length==0){
    $('#person_content #content_left .social .soc_two .user').html("暂无数据");
}else{
...
if(comment_1.length==0||comment_2.length==0){
    $('#person_content #content_left .social .soc_three .user').html("暂无数据");
}else{
...
if(becomment_1.length==0||becomment_2.length==0){
    $('#person_content #content_left .social .soc_four .user').html("暂无数据");
}else{
