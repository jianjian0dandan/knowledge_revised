...
def train_gbdt():
    ...
    training_data = []
    count = -1
    with open("feature_13.txt","r") as f:
        for line in f:
            count += 1
            line = line.strip()
    ...
    X_train, X_test, y_train, y_test = cross_validation.train_test_split(training_data, training_weibo_value, test_size=0.2, random_state=0)
    ...
    with open("prediction_weibo.pkl" ,"wb") as f:
        pickle.dump(gbdt, f)
