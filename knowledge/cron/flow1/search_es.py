...
def user_index_cal(origin_weibo_number, retweeted_weibo_number, user_fansnum, influence_origin_weibo_retweeted, influence_origin_weibo_comment, influence_retweeted_weibo_retweeted, influence_retweeted_weibo_comment):
        user_index = 300*(0.2*(0.6*math.log(origin_weibo_number+1)+0.3*math.log(retweeted_weibo_number+1)+0.1*math.log(int(user_fansnum)+1))+0.8*(0.3*influence_origin_weibo_retweeted+0.3*influence_origin_weibo_comment+0.2*influence_retweeted_weibo_retweeted+0.2*influence_retweeted_weibo_comment))
        return user_index
...
if __name__ == "__main__":
    ...
    active_list_1 = search_top_k(20000, '20130901')
    active_list_2 = search_top_k(20000, '20130902')
    active_set = list_merge(active_list_1, active_list_2)
    store_to_elasticsearch(es, active_set, "20150625")
